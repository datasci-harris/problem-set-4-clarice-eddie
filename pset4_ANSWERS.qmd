...
# path for clarice: 'C:/Users/clari/OneDrive/Documents/Python II/pos_files/pos_6789.csv'
...
zips_all_centroids = zips_all_centroids.to_crs(epsg=3857)  # Convert to projected CRS (e.g., EPSG:3857)
...
The amount of time changes, but I get around .17-.25 seconds to run 10 zip codes.
...
For me, the full calculation took 33.18 seconds, much longer than just doing 10 zip codes. 
It's around 132.72 times longer.
